...
// Layer Activation and Deactivation tests for sagta_topo Project

import { test, expect } from '@playwright/test';

test.describe('Layer Activation and Deactivation - sagta_topo Project', () => {
  ...
  test('Activate All Layers in sagta_topo', async ({ page }) => {
  ...
  test('Deactivate All Layers in sagta_topo', async ({ page }) => {
    // Precondition: User is logged in and viewing sagta_topo project
    await login(page);
  ...
  test('Toggle Individual Layers in sagta_topo', async ({ page }) => {
    // Precondition: User is logged in and viewing sagta_topo project
    await login(page);
