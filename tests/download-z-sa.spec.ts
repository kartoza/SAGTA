...
// Download Map tests for z_sa Project

import { test, expect } from '@playwright/test';

test.describe('Download Maps - z_sa Project', () => {
  ...
  test('Download z_sa - A3 Landscape Layout', async ({ page, context }) => {
  ...
  test('Download z_sa - A3 Portrait Layout', async ({ page, context }) => {
    await login(page);
    const z_saProject = page.locator('text=z_sa').first();
    await z_saProject.click();
    await page.waitForLoadState('networkidle');
  ...
  test('Download z_sa - A4 Landscape Layout', async ({ page, context }) => {
    await login(page);
    const z_saProject = page.locator('text=z_sa').first();
    await z_saProject.click();
    await page.waitForLoadState('networkidle');
  ...
  test('Download z_sa - A4 Portrait Layout', async ({ page, context }) => {
    await login(page);
    const z_saProject = page.locator('text=z_sa').first();
    await z_saProject.click();
    await page.waitForLoadState('networkidle');
