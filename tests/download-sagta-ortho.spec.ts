...
// Download Map tests for sagta_ortho Project

import { test, expect } from '@playwright/test';

test.describe('Download Maps - sagta_ortho Project', () => {
  ...
  test('Download sagta_ortho - A3 Landscape Layout', async ({ page, context }) => {
  ...
  test('Download sagta_ortho - A3 Portrait Layout', async ({ page, context }) => {
    await login(page);
    const sagta_orthoProject = page.locator('text=sagta_ortho').first();
    await sagta_orthoProject.click();
    await page.waitForLoadState('networkidle');
  ...
  test('Download sagta_ortho - A4 Landscape Layout', async ({ page, context }) => {
    await login(page);
    const sagta_orthoProject = page.locator('text=sagta_ortho').first();
    await sagta_orthoProject.click();
    await page.waitForLoadState('networkidle');
  ...
  test('Download sagta_ortho - A4 Portrait Layout', async ({ page, context }) => {
    await login(page);
    const sagta_orthoProject = page.locator('text=sagta_ortho').first();
    await sagta_orthoProject.click();
    await page.waitForLoadState('networkidle');
